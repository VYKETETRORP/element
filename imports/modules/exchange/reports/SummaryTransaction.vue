    ...
    >
      ...
      <template #header>
        <div class="report-name">
          <!-- {{ reportName }} -->
          {{ $t('exchange.tranReport.transaction-summary') }}
        </div>
        ...
        >
          ...
          <tbody>
            ...
            >
              <tr>
                <td>{{ index + 1 }}</td>
                <td>{{ doc.baseName }}-{{ doc.toName }}</td>
                <!--<td class="text-right">
                  {{
                    $filters.exchangeBaseCurrency(doc.received, doc.fromSymbol)
                  }}
                </td>-->
                <td class="text-right">
                  {{ doc.received.toLocaleString() }} {{ doc.fromSymbol }}
                </td>
                <td class="text-right">
                  {{ doc.exchangeAmount.toLocaleString() }} {{ doc.fromSymbol }}
                </td>
                <td class="text-right">
                  {{ doc.amount.toLocaleString() }} {{ doc.toSymbol }}
                </td>
                <td class="text-right">
                  {{ doc.return.toLocaleString() }} {{ doc.fromSymbol }}
                </td>
                <td class="text-right">
                  {{ doc.netIncome.toLocaleString() }} {{ doc.fromSymbol }}
                </td>
              </tr>
            </template>
          </tbody>
...
import { reportSummaryTransaction } from '../api/reports/exchange-transaction-summary'
