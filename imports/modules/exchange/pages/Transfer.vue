  ...
  <div>
    <el-card shadow="never">
      <!-- <div #header class="header">
        <span>
          {{ $t('exchange.customer-setting.Transfer') }}
        </span>
      </div> -->
      <el-row class="mb-2">
        <el-col :span="16">
...
export default {
  ...
  computed: {
    ...
    tableTitles() {
      const opt = [
        ...
        {
          label: `${this.$t('exchange.transfer.fromEmployee')}`,
          prop: 'fromName',
        },
        {
          label: `${this.$t('exchange.transfer.toEmployee')}`,
          prop: 'name',
        },
        {
  ...
  methods: {
    ...
    //     this.tableProps.height = `calc(100vh - 243px)`
    //   }
    // },
    getData() {
      const selector = {
